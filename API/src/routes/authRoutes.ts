...
import { changePasswordSchema, emailSchema, emailVerificationSchema, loginSchema, otpSchema, resgiterSchema } from "../validationSchema/authSchema";
...
router.post("/verifyOtp",validateReqBody(emailVerificationSchema), verifyAuth, handleOtpVerification);
